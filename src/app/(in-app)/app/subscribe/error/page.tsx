...
type ErrorCodeType =
  ...
  | "PADDLE_CANCEL_BEFORE_SUBSCRIBING"
  | "POLAR_CANCEL_BEFORE_SUBSCRIBING"
  | "POLAR_CHECKOUT_CANCELLED"
  | "PAYPAL_CANCELLED"
  | "INVALID_PARAMS";
...
const errorMessages: ErrorMessages = {
  ...
  POLAR_CANCEL_BEFORE_SUBSCRIBING:
    "Please cancel your current subscription before subscribing to a new onetime plan.",
  POLAR_CHECKOUT_CANCELLED: "Checkout was cancelled.",
    ...
    <div className="container max-w-lg mx-auto py-12">
      <Card className="p-6">
        <div className="flex flex-col items-center text-center space-y-4">
          ...
          {(code === "PADDLE_CANCEL_BEFORE_SUBSCRIBING" ||
            code === "POLAR_CANCEL_BEFORE_SUBSCRIBING") && (
            <div className="flex flex-col gap-2 items-center">
              <p>
                If you want to cancel your current subscription, please go to
                your billing page.
