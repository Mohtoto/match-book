...
export const planFormSchema = z.object({
  ...
  default: z.boolean(),
  hasOnetimePricing: z.boolean(),
  hasMonthlyPricing: z.boolean(),
  hasYearlyPricing: z.boolean(),
  ...
  monthlyPaddlePriceId: z.string().nullable(),
  monthlyPaypalPlanId: z.string().nullable(),
  monthlyPolarProductId: z.string().nullable(),
  ...
  yearlyPaddlePriceId: z.string().nullable(),
  yearlyPaypalPlanId: z.string().nullable(),
  yearlyPolarProductId: z.string().nullable(),
  ...
  onetimePaddlePriceId: z.string().nullable(),
  onetimePaypalPlanId: z.string().nullable(),
  onetimePolarProductId: z.string().nullable(),
  quotas: quotaSchema,
});
