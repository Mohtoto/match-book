...
GitHub Actions runs on push/PR only when the repo owner is [`Indie-Kit`](https://github.com/Indie-Kit) (upstream). Forks and personal clones skip the build automatically — use **Actions → CI → Run workflow** to trigger manually.

To run the stack with Postgres in Docker, see [docker/README.md](docker/README.md).
